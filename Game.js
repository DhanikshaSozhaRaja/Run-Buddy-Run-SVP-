...
background(gameOverImg);
 ...
 spawnObstacles(){
  if(frameCount % 100 === 0) {
    ...
    obstacle.velocityX = -(6 + 2*score/20);
 ...
 score = 0;
   ...
   spawntrea(){
    if (frameCount % 500 === 0) {
        var coin1 = createSprite(displayWidth+500,displayHeight-200,40,10);
  ...
  boo.scale = 0.15;
   ...
   spawnCoins(){
    if (frameCount % 100 === 0) {
        var coin = createSprite(displayWidth+500,displayHeight-60,40,10);
