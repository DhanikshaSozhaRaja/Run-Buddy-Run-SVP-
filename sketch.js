...
var coin,restartImg,musde,musbo,musju,fbac,cast,form,cas,invi,jSound,cs;
var obstaclesGroup,cloudsGroup,gameOver,coinImg,dino,mon,coi2,treaGroup;
var PLAY = 1,END = 0,gameState = 3,score = 0,boost,visi1,score = 0,esou;
var back,clo,gameOverImg,sto,coinsGroup,restart,bari,poi,trea,zo,fSound;
...
you_running=loadAnimation("images/r1-removebg-preview.png","images/r2-removebg-preview.png","images/r3-removebg-preview.png","images/r4-removebg-preview.png","images/r5-removebg-preview.png","images/r6-removebg-preview.png");
  gameOverImg=loadImage("images/go.jpeg");
...
fSound = loadSound("sound/bensound-funnysong.mp3");
jSound = loadSound("sound/mixkit-sci-fi-positive-notification-266.wav");
esou = loadSound("sound/mixkit-game-level-music-689.mp3");
boost = loadImage("images/Boost.png");
cs = loadSound("sound/mixkit-arcade-video-game-bonus-2044.wav");
